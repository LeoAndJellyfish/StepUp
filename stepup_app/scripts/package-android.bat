...
echo 创建README文件...
(
echo StepUp综测系统 Android版 v%VERSION% %DESCRIPTION%
echo ================================================================
echo.
echo 版本信息：
echo - 版本号：v%VERSION%
...
echo - 构建时间：%date% %time%
echo - 目标平台：Android 5.0+ ^(API 21+^)
echo - 安装包：app-release.apk
echo.
echo 安装说明：
echo 1. 在 Android 设备上启用"允许安装未知来源应用"
echo    - 设置 ^> 安全 ^> 允许安装未知来源应用
echo    - 或设置 ^> 应用 ^> 特殊应用权限 ^> 安装未知应用
echo.
echo 2. 将 app-release.apk 传输到 Android 设备
echo    - 通过 USB 连接电脑传输
echo    - 或通过邮件/微信/QQ 发送到手机
echo    - 或通过网络传输工具
echo.
echo 3. 在设备上找到 APK 文件并点击安装
echo    - 使用文件管理器找到 APK 文件
echo    - 点击安装，按提示完成安装
echo.
echo 4. 安装完成后，在应用列表中找到"StepUp综测系统"启动
echo.
echo 主要功能：
echo - 综合测评条目管理
echo - 分类和级别管理
...
echo.
echo 数据存储：
echo - 数据库：应用私有目录，随应用卸载删除
echo - 证明材料：应用私有目录，随应用卸载删除
echo - 建议定期使用应用内备份功能导出数据
echo.
echo 权限说明：
echo - 存储权限：用于上传和保存证明材料
echo - 相机权限：用于拍照上传证明材料
echo - 网络权限：用于坚果云备份功能
echo.
echo 技术支持：
echo 如有问题，请联系开发团队
